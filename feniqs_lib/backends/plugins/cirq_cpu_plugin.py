...
from ..quantum_backends.cirq_simulator_backend import CirqCpuBackend
...
class CirqCpuPlugin:
    ...
    def run_backend(self, test_case: str, nb_shots: int, seed: int, **kwargs):
        ...
        return run_backend_common(CirqCpuBackend, test_case, nb_shots, seed, None, global_config.incl_first, global_config.runs, **kwargs)

def plugin():
    return CirqCpuPlugin()
