...
from ..quantum_backends.yao_backend import YaoCpuBackend
...
class YaoCpuPlugin:
    ...
    def run_backend(self, test_case: str, nb_shots: int, seed: int, env: str, **kwargs):
        ...
        return run_backend_common(YaoCpuBackend, test_case, nb_shots, seed, env, global_config.incl_first, global_config.runs, **kwargs)
