...
from ..quantum_backends.qiskit_cloud_backend import QiskitCloudBackend
...
class QiskitAerCpuPlugin:
    ...
    def run_backend(self, test_case: str, nb_shots: int, seed: int, **kwargs):
        ...
        return run_backend_common(QiskitCloudBackend, test_case, nb_shots, seed, None, global_config.incl_first, global_config.runs, **kwargs)
